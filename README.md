...
- Integrated key features such as **Mark down and  support** for note creation, **category-based organization**, and a **filtering system** for efficient note retrieval.
